...
stm =
  let packageId = PackageId (read "31fc55bc-44c4-11ec-b940-5405db82c3cd")
      ...
      synopsis = "Software Transactional Memory, or STM, is an abstraction for concurrent communication. The main hackageUserefits of STM are composability and modularity. That is, using STM you can write concurrent abstractions that can be easily composed with any other abstraction built using STM, without exposing the details of how your abstraction ensures safety. This is typically not the case with other forms of concurrent communication, such as locks or MVars."
      ownerId = hackageUser ^. #userId
      createdAt = read "2014-03-23 23:03:32 UTC"
      updatedAt = read "2021-11-03 11:30:00 UTC"
      metadata = PackageMetadata
